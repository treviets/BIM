...
public class ProjectBaseLineServiceImpl implements ProjectBaseLineService {
	...
	@Override
	public Result getBaseLineByType(int projectId, int type, int clientId) {
		// TODO Auto-generated method stub
		final List<BaseLines> listBaselines = projectBaseLineDao.getBaseLineByType(projectId, type, clientId);
		final Map<String, Object> result = new HashMap<String, Object>();
		result.put("listBaselines", listBaselines);
		return new Result(result, true);
	}
