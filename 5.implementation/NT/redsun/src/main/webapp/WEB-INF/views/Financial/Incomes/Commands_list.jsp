	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<div class="row">
				...
				<!-- filter by name -->
				<div class="col-md-2">
					<input type="text" ng-model="command.name" class="inpput-sm" placeholder="<spring:message code="command.name"/>" />
				</div>
				<!-- filter by projectName -->
				<div class="col-md-2">
					<input type="text" ng-model="command.projectName" class="inpput-sm" placeholder="<spring:message code="command.projectName"/>" />
				</div>
				<!-- filter by commandTypeName -->
				<div class="col-md-2">
					<input type="text" ng-model="command.commandTypeName" class="inpput-sm" placeholder="<spring:message code="command.commandTypeName"/>" />
				</div>
				<!-- filter by description -->
				<div class="col-md-2">
					<input type="text" ng-model="command.description" class="inpput-sm" placeholder="<spring:message code="command.description"/>" />
				</div>
				<!-- filter by statusName -->
				<div class="col-md-2">
					<input type="text" ng-model="command.statusName" class="inpput-sm" placeholder="<spring:message code="command.statusName"/>" />
				</div>
				<!-- filter button -->
				<div class="col-md-2">
					<button type="button" class="btn" ng-click="getsForPageAndFilter(1)" data-toggle="tooltip" title='<spring:message code="command.tooltip.search"></spring:message>'><span class="glyphicon glyphicon-search"></span></button>
				</div>
			...
			<div class="row">
				...
				<div class="btn-group pull-right">
					<button class="btn btn-info" ng-click="add()" data-toggle="tooltip" title='<spring:message code="command.tooltip.create"></spring:message>'>
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th ng-click="sortBy('name')"><spring:message code="command.name"/>
								<span ng-show="sortKey === 'name'" class="glyphicon sort-icon" ng-class="{'glyphicon-chevron-up': reverse, 'glyphicon-chevron-down': !reverse}"/>
							</th>
							<th ng-click="sortBy('projectName')"><spring:message code="command.projectName"/>
							...
							<th ng-click="sortBy('commandTypeName')"><spring:message code="command.commandTypeName"/>
							...
							<th ng-click="sortBy('description')"><spring:message code="command.description"/>
							...
							<th ng-click="sortBy('statusName')"><spring:message code="command.statusName"/>
