...
public class ProjectController {
	...
	@RequestMapping(value = "/list/by-resource/{username}/", method = { RequestMethod.GET })
	public Object getAllProjectByResourceId(@PathVariable("username") String username) {
		return projectService.getProjectByResourceUsername(username);
	}
