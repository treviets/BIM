app.controller('pmReportCtrl',['$scope', '$compile', '$rootScope', '$filter', '$mdDialog', '$http', '$templateRequest', '$timeout', '$log',
               '$window', 'projectService', 'projectBaselineService', function($scope, $compile, $rootScope, $filter, $mdDialog, $http, $templateRequest, $timeout,$log,
		$window, projectService, projectBaselineService) {
	...
	$scope.reports = [
		...
		{id:9, name:"Labor Baseline In Project", file_name:"labor-baseline-sheet", controller_name:"pmReExpenseCtrl", cat_id:3},
		{id:10, name:"Time sheet In Project", file_name:"timesheet-sheet", controller_name:"pmReExpenseCtrl", cat_id:3},
		{id:11, name:"Equipment In Project", file_name:"equipment-sheet", controller_name:"pmReExpenseCtrl", cat_id:4}
	];
