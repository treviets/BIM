...
public class ProjectBaseLineDaoImpl implements ProjectBaseLineDao {
	...
	private static String ADD_BASELINE = "INSERT INTO baselines (name, baseline_type, baseline_date, description, client_id) VALUES (?, ?, ?::date, ?, ?)";
	...
	private final static String SELECT_PRSBL_BY_PROJECTID = "SELECT pr.id, pr.project_id, pr.resource_id, pr.salary, pr.quantity, pr.client_id, '' as resource_code, '' as resource_name, '' as email"
			+ " FROM project_resource_baselines AS pr"
