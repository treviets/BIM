	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<div class="row">
				...
				<!-- filter by name -->
				<div class="col-md-2">
					<input type="text" ng-model="bill.name" class="inpput-sm" placeholder="<spring:message code="bill.name"/>" />
				</div>
				<!-- filter by projectName -->
				<div class="col-md-2">
					<input type="text" ng-model="bill.projectName" class="inpput-sm" placeholder="<spring:message code="bill.projectName"/>" />
				</div>
				<!-- filter by billTypeName -->
				<div class="col-md-2">
					<input type="text" ng-model="bill.billTypeName" class="inpput-sm" placeholder="<spring:message code="bill.billTypeName"/>" />
				</div>
				<!-- filter by description -->
				<div class="col-md-2">
					<input type="text" ng-model="bill.description" class="inpput-sm" placeholder="<spring:message code="bill.description"/>" />
				</div>
				<!-- filter button -->
				<div class="col-md-2">
					<button type="button" class="btn" ng-click="getsForPageAndFilter(1)" data-toggle="tooltip" title='<spring:message code="bill.tooltip.search"></spring:message>'><span class="glyphicon glyphicon-search"></span></button>
				</div>
			...
			<div class="row">
				...
				<div class="btn-group pull-right">
					<button class="btn btn-info" ng-click="add()" data-toggle="tooltip" title='<spring:message code="bill.tooltip.create"></spring:message>'>
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th ng-click="sortBy('name')"><spring:message code="bill.name"/>
								<span ng-show="sortKey === 'name'" class="glyphicon sort-icon" ng-class="{'glyphicon-chevron-up': reverse, 'glyphicon-chevron-down': !reverse}"/>
							</th>
							<th ng-click="sortBy('projectName')"><spring:message code="bill.projectName"/>
							...
							<th ng-click="sortBy('billTypeName')"><spring:message code="bill.billTypeName"/>
							...
							<th ng-click="sortBy('description')"><spring:message code="bill.description"/>
