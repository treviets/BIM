...
<div ng-controller="trendController" ng-init="initList()">
	<!-- panel -->
	<div class="panel">
		<!-- filter	 -->
		<div class="row panel-heading">
			<!-- filter by name -->
			<div class="col-md-2">
				<input type="text" ng-model="trend.name" class="inpput-sm" />
			</div>
			<!-- filter by color -->
			<div class="col-md-2">
				<input type="text" ng-model="trend.color" class="inpput-sm" />
			</div>
			<!-- filter by sortOrder -->
			<div class="col-md-2">
				<input type="text" ng-model="trend.sortOrder" class="inpput-sm" />
			</div>
			<!-- filter by icon -->
			<div class="col-md-2">
				<input type="text" ng-model="trend.icon" class="inpput-sm" />
			</div>
			<!-- filter by idle -->
			<div class="col-md-2">
				<input type="text" ng-model="trend.idle" class="inpput-sm" />
			</div>
			<!-- filter button -->
			<div class="col-md-2">
			...
			<table class="table">
				<thead>
					<tr>
						...
						<th ng-click="sortBy('sortOrder')"><spring:message code="trend.sortOrder"/>
				...
				<tbody>
					<tr ng-show="trend.length">
						<td colspan="4" style="text-align: center;"><spring:message code="common.loading"></spring:message></td>
					</tr>
					<tr dir-paginate="item in trends | orderBy:sortKey:reverse | itemsPerPage:itemsPerPage" total-items="totalCount">
						<td>{{item.name}}</td>
						<td>{{item.color}}</td>
