var demo_tasks = {
	"data":[
		{"id":1, "text":"Project #2", "start_date":"01-04-2017", "duration":"18", "progress": 0.4, "open": true, "priority":"low", "assignee":"vucao", "owner":"admin"},

		{"id":2, "text":"Task #1", "start_date":"02-04-2017", "duration":"8", "parent":"1", "progress":0.5, "open": true , "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":3, "text":"Task #2", "start_date":"11-04-2017", "duration":"8", "parent":"1", "progress": 0.6, "open": true , "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":4, "text":"Task #3", "start_date":"13-04-2017", "duration":"6", "parent":"1", "progress": 0.5, "open": true , "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":5, "text":"Task #1.1", "start_date":"02-04-2017", "duration":"7", "parent":"2", "progress": 0.6, "open": true , "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":6, "text":"Task #1.2", "start_date":"03-04-2017", "duration":"7", "parent":"2", "progress": 0.6, "open": true , "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":7, "text":"Task #2.1", "start_date":"11-04-2017", "duration":"8", "parent":"3", "progress": 0.6, "open": true, "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":8, "text":"Task #3.1", "start_date":"14-04-2017", "duration":"5", "parent":"4", "progress": 0.5, "open": true, "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":9, "text":"Task #3.2", "start_date":"14-04-2017", "duration":"4", "parent":"4", "progress": 0.5, "open": true, "priority":"low", "assignee":"vucao", "owner":"admin"},
		{"id":10, "text":"Task #3.3", "start_date":"14-04-2017", "duration":"3", "parent":"4", "progress": 0.5, "open": true, "priority":"low", "assignee":"vucao", "owner":"admin"}
...
var projects_with_milestones = {
	"data":[
		{"id":11, "text":"Project #1", type:redsun.config.types.project, "progress": 0.6, "open": true},

		{"id":12, "text":"Task #1", "start_date":"03-04-2013", "duration":"5", "parent":"11", "progress": 1, "open": true},
		{"id":13, "text":"Task #2", "start_date":"03-04-2013", type:redsun.config.types.project, "parent":"11", "progress": 0.5, "open": true},
		{"id":14, "text":"Task #3", "start_date":"02-04-2013", "duration":"6", "parent":"11", "progress": 0.8, "open": true},
		{"id":15, "text":"Task #4", type:redsun.config.types.project, "parent":"11", "progress": 0.2, "open": true},
		{"id":16, "text":"Final milestone", "start_date":"15-04-2013", type:redsun.config.types.milestone, "parent":"11", "progress": 0, "open": true},
		...
		{"id":23, "text":"Mediate milestone", "start_date":"14-04-2013", type:redsun.config.types.milestone, "parent":"15", "progress": 0, "open": true}
	],
	"links":[
		{"id":"10","source":"11","target":"12","type":"1"},
		{"id":"11","source":"11","target":"13","type":"1"},
