...
/**
 * Criticalities Controller
 */
@Controller
@RequestMapping("criticalities")
public class CriticalitiesController extends BaseController{
	 ...
	 @RequestMapping(value="/list", method={RequestMethod.GET})
	    ...
	    public Object getAll(HttpServletRequest request) throws Exception  {
		 Authentication auth = SecurityContextHolder.getContext().getAuthentication();
	    	...
	    	String getDataURL = getMainDomain(request) + RedSunURLs.CRITICALITIES_URL_GET_ALL + clientId;
