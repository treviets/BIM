		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title pull-left">
					<spring:message code="resource.title" />
				</h3>
			</div>
			...
			<select class="form-control" ng-model="resource.name" 
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group form-group-sm {{codeError}}" >
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" ng-model="resource.code">
							</div>
					</div>
					<div class="form-group form-group-sm {{resourceNameError}}" >
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" ng-model="resource.name">
						</div>
					</div>
					...
					<div class="form-group form-group-sm {{titleError}}" >
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" ng-model="resource.title">
						</div>
					</div>
					<div class="form-group form-group-sm">
						<label class="col-sm-2 control-label" for="formGroupInputSmall"><spring:message
					...
					<div class="form-group form-group-sm {{mobileError}}">
						...
						<div class="col-sm-10">
								<input class="form-control" type="number" id = "mobile" ng-model="resource.mobile"/>
					...
					<div class="form-group form-group-sm">
							...
							<div class="col-sm-10">
									<input class="form-control" type="number" id = "phone" ng-model="resource.phone"/>
					...
					<div class="form-group form-group-sm {{idCardError}}" >
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" ng-model="resource.idCard">
						</div>
					</div>
					<div class="form-group form-group-sm">
						<label class="col-sm-2 control-label" for="formGroupInputSmall"><spring:message
					...
					<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
						<div class="form-group form-group-sm">
							<div class="col-sm-12 text-center">
								<button type="button" class="btn btn-default" ng-click="backListExterior()">Back</button>
								<button ng-if="checkPermission('HR_3') || checkPermission('HR_2')" type="button" class="btn btn-info" ng-click="saveExterior(${id})">
