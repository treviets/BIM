  		...
  		<div class="panel panel-default">
  			<div class="panel-heading clearfix">
      			...
      			<div class="pull-right">
      				<span ng-click="addProject();" class="glyphicon glyphicon-plus" title="click here to add new project" ng-if="checkPermission('Design_2') || checkPermission('Design_3')"></span>&nbsp;&nbsp;&nbsp;
